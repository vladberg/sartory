...
if($_POST){
    ...
    echo $tranx="update cotizacion set empresa='$cliente',cotizado_por='$cotizado_por' where hora='$id'";
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
							...
							$query="SELECT DISTINCT usuario,fecha,estatus,hora,empresa,cotizado_por,envio FROM cotizacion where estatus=2 order by fecha desc;";
